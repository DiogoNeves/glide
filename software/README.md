...
Start read-only. Ask before writing, sending, deleting, archiving, purchasing, posting, scheduling, approving, or changing account data.

Default durable memory and operating updates to `Glide HQ/`, not external apps, unless the user explicitly asks to write somewhere else.

macOS may require the user to approve Automation, Full Disk Access, Files and Folders, or app-specific permissions for the harness or terminal app. Do not bypass privacy prompts or blindly click security dialogs.
